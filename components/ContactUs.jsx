...
import { Mail, Phone, MapPin, Send, ArrowRight, Zap } from "lucide-react";
...
const Button = ({
  ...
  const baseStyles =
    "px-6 py-3 rounded-lg font-medium transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-black";
  const variants = {
    default:
      "bg-red-600 text-white hover:bg-red-500 focus:ring-red-500 shadow-lg hover:shadow-red-500/25",
    outline:
      "border border-red-500/30 text-red-400 hover:bg-red-500/10 hover:border-red-500 focus:ring-red-500/50",
  };
...
const ContactUs = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-950 via-black to-gray-900 text-white relative overflow-hidden">
      {/* Navbar with proper positioning and z-index */}
      ...
      {/* Main Content - Adjusted top padding to account for navbar */}
          ...
          <div className="space-y-6">
            <div>
              ...
              <p className="text-gray-300 text-base lg:text-lg leading-relaxed">
                Have questions about Bennovate 4.0 or ready to
                <br />
