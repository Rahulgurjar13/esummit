...
const JuniorTeamSection = () => {
  const teams = {
    coreLeadership: [
      ...
      { id: 5, name: 'Shruti', role: 'Chief of Operations', image: 'public/images/shruti.jpeg', bio: 'Ensuring smooth operational execution.' },
      { id: 6, name: 'Saransh', role: 'Chief of Startup Support', image: 'public/images/IMG_6915 - Saransh Jain.jpeg', bio: 'Supporting startup initiatives and growth.' },
    ],
    pr: [
    ...
    design: [
      { id: 11, name: 'Dhruv', role: 'Head of Design', image: 'public/images/SAVE_20250211_155223 - Dhruv Mehta.jpg', bio: 'Leading the design team for creative output.' },
      ...
      { id: 13, name: 'Ayushika', role: 'Designer', image: 'public/images/ID - Ayushika Verma.jpg', bio: 'Contributing to design projects.' },
      { id: 14, name: 'Kunal', role: 'Designer', image: 'public/images/IMG_9481 - Kunal Hooda.jpeg', bio: 'Crafting innovative design solutions.' },
    ...
    multimedia: [
      { id: 16, name: 'Krish', role: 'Head of Multimedia', image: 'public/images/IMG_20240330_153516 - Krish Garg.jpg', bio: 'Leading multimedia content creation.' },
      { id: 17, name: 'Krishna', role: 'Multimedia Member', image: 'public/images/IMG_9912 - Krishna Goyal.jpeg', bio: 'Producing engaging multimedia content.' },
      { id: 18, name: 'Kartikeya', role: 'Multimedia Member', image: 'public/images/IMG_20250821_150724-removebg-preview - Kartikeya Singh.jpg', bio: 'Supporting multimedia projects.' },
      { id: 19, name: 'Tanmay', role: 'Multimedia Member', image: 'public/images/IMG_0267 - YEDSTER.JPG', bio: 'Creating dynamic visual content.' },
    ],
    socialMedia: [
      { id: 20, name: 'Akansha', role: 'Social Media Lead/Member', image: 'public/images/View recent photos.jpeg - Akansha Bhutani.png', bio: 'Managing social media presence.' },
    ...
    operations: [
      { id: 23, name: 'Manish', role: 'Head of Operations', image: 'public/images/IMG_20250820_085107 - Manish Solanki.jpg', bio: 'Overseeing operational workflows.' },
      { id: 24, name: 'Arya', role: 'Operations Member', image: 'public/images/IMG_8998 - Arya Prakash.jpeg', bio: 'Supporting operational tasks.' },
      { id: 25, name: 'Riddhima', role: 'Operations Member', image: 'public/images/Screenshot_2025-03-27-20-42-40-592_com.android.chrome-edit - Riddhima Srivastava.jpg', bio: 'Ensuring smooth operations.' },
      ...
      { id: 27, name: 'Aarushi', role: 'Operations Member', image: 'public/images/Snapchat-385519136 - Arushi Chakraborty.jpg', bio: 'Supporting event and task coordination.' },
      ...
      { id: 29, name: 'Ishaan', role: 'Operations Member', image: 'public/images/DSC00935 - Ishaan Sharma.JPG', bio: 'Assisting in operational planning.' },
    ...
    events: [
      ...
      { id: 32, name: 'Devanshi', role: 'Events Member', image: 'public/images/spark - Devanshi.jpg', bio: 'Coordinating event logistics.' },
      { id: 33, name: 'Sanchit', role: 'Events Member', image: 'public/images/sanchit.jpg', bio: 'Supporting event organization.' },
      ...
      { id: 35, name: 'Janwi', role: 'Events Member', image: 'public/images/beep - Janwi singh.JPG', bio: 'Contributing to event success.' },
    ],
    tech: [
      { id: 36, name: 'Rahul', role: 'Head of Tech', image: 'public/images/rahul1.jpg', bio: 'Leading technical development.' },
    ...
    finance: [
      { id: 40, name: 'Ananya', role: 'Sponsorships Head', image: 'public/images/IMG_0515 - Ananya Mishra.jpeg', bio: 'Leading sponsorship and finance efforts.' },
      ...
      { id: 42, name: 'Divine', role: 'Finance Member', image: 'public/images/divine.jpg', bio: 'Supporting financial planning.' },
      { id: 43, name: 'Himani', role: 'Finance Member', image: 'public/images/IMG_1301 - _himanii _.png', bio: 'Assisting in sponsorship coordination.' },
      { id: 44, name: 'Janvi', role: 'Finance Member', image: 'public/images/IMG_20250821_150432 - Janvi Pargai.jpg', bio: 'Contributing to financial strategies.' },
      { id: 45, name: 'Anushka', role: 'Finance Member', image: 'public/images/IMG_3075 - Anushka Mishra.jpeg', bio: 'Supporting budget management.' },
      { id: 46, name: 'Manthan', role: 'Finance Member', image: 'public/images/IMG_20241127_192028_Original - MJforti.jpeg', bio: 'Assisting in financial operations.' },
      { id: 47, name: 'Parth', role: 'Finance Member', image: 'public/images/Screenshot_20250821_174943_Gallery - Parth Gaur.jpg', bio: 'Contributing to sponsorship efforts.' },
    ],
  };
