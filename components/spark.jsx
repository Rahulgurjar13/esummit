  ...
  const values = [
    {
      ...
      description:
        "We foster creative thinking and breakthrough solutions that address real-world challenges.",
    },
    {
      icon: Users,
      title: "Community Driven",
      description:
        "Building strong networks of entrepreneurs, mentors, and industry professionals.",
    },
    {
      icon: TrendingUp,
      title: "Impact Focused",
      description:
        "Measuring success through tangible outcomes and sustainable business growth.",
    },
    {
      icon: Globe,
      title: "Global Perspective",
      description:
        "Connecting local talent with global opportunities and international best practices.",
    },
  ];
  ...
  const leadership = [
    {
      ...
      background:
        "Mentoring, Monitoring and Evaluation, Networking Fundraising Support & Business Modelling MBA, (Pursuing Ph.D. in Entrepreneurship), 14+ Years of Exp.",
    ...
    },
    {
      ...
      background:
        "Expertise in Entrepreneurship & Gender | 10+ years in Academia, Corporate, Govt & NGOs | Teaching Economics & Entrepreneurship | Econ Hons (DU), Ph.D. (JMI) ",
    ...
    },
    {
      ...
      background:
        "Mentoring, Monitoring and Evaluation, Networking Fundraising Support & Business Modelling, Accelerator programs MBA Marketing & IB, 7 years exp. ",
    ...
    },
    {
      ...
      background:
        "Data Analysis, Project Management, Networking, Regulatory Compliance, Stakeholder Management PGDM (MBA), MCA, 10+ Years Exp. ",
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-gray-300 mb-8 leading-relaxed">
                Igniting entrepreneurial excellence through innovation,
                mentorship, and real-world impact. Where ideas transform into
                successful ventures.
              </p>
              ...
              <div className="flex items-center gap-4">
                ...
                <div className="flex gap-3">
                  <a
                    href="#"
                    className="w-10 h-10 bg-gray-800 hover:bg-red-600 rounded-lg flex items-center justify-center"
                  >
                    <Instagram size={18} />
                  </a>
                  <a
            ...
            <div className="relative">
              <div className="bg-gradient-to-br from-gray-900 to-black border border-gray-800 rounded-3xl p-8 shadow-2xl">
                <div className="grid grid-cols-2 gap-6">
                  ...
                  <div className="bg-red-500/10 border border-red-500/20 rounded-2xl p-6 text-center">
                    <Building2
                      className="text-red-400 mb-3 mx-auto"
                      size={32}
                    />
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {values.map((value, index) => (
              <div
                key={index}
                className="bg-black border border-gray-800 rounded-2xl p-8 text-center hover:border-red-500/30"
              >
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <div className="space-y-6 text-lg text-gray-300 leading-relaxed">
                <p>
                  Founded in 2019, SPARK E-Cell has evolved from a student
                  initiative to become Bennett University's premier
                  entrepreneurship ecosystem. We're not just another college
                  club – we're a comprehensive platform that bridges the gap
                  between academic learning and real-world business success.
                </p>
                <p>
                  Our approach is rooted in experiential learning, industry
                  partnerships, and measurable outcomes. Every program we
                  design, every mentor we onboard, and every startup we support
                  is aligned with one goal: creating successful entrepreneurs
                  who solve meaningful problems.
                </p>
                <p>
                  Today, our alumni network spans across 15+ countries, our
                  startups have collectively raised over ₹250 crores, and our
                  programs have been recognized nationally for innovation in
            ...
            <div>
              <div className="bg-gradient-to-br from-gray-900 to-black border border-gray-800 rounded-3xl p-8 shadow-2xl">
                ...
                <p className="text-gray-300 leading-relaxed mb-8">
                  To democratize entrepreneurship education and create a
                  sustainable ecosystem where innovative ideas are nurtured,
                  funded, and scaled to create meaningful societal and economic
                  impact.
                </p>
                <div className="space-y-4">
                  <div className="flex items-center gap-4 p-4 bg-red-500/5 border border-red-500/20 rounded-xl">
                    ...
                    <span className="text-gray-300">
                      Practical, outcome-focused programs
                    </span>
                  </div>
                  <div className="flex items-center gap-4 p-4 bg-red-500/5 border border-red-500/20 rounded-xl">
                    <div className="w-2 h-2 bg-red-500 rounded-full" />
